# Integration Example — Astro 5

Integration example for validating `@storybook-astro/framework` against **Astro 5** (stable). Deployed as the [Astro 5 demo](https://demo-astro5.storybook-astro.org).
