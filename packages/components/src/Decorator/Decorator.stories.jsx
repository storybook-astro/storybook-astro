...
// Component-level decorator (docs/DECORATOR_SUPPORT.md, Step 4): every story in
...
export default {
  ...
  // Wrapper's default slot automatically (docs/DECORATOR_SUPPORT.md).
  decorators: [(_Story) => ({ component: Wrapper, props: { label: 'Wrapped in preview' } })],
  parameters: {
    docs: {
      description: {
        component:
          'A component-level Astro decorator wraps every story in this file with `Wrapper.astro`. Covers both the static prerender and server-mode render paths (docs/DECORATOR_SUPPORT.md).',
      },
    },
  },
};
